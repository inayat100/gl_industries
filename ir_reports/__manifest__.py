# -*- coding: utf-8 -*-
{
   ...
   """,
    "depends": [
        "base", "sale", "mail", "purchase", "account", "product", "ir_sale_report", "ir_record_lock_config", "hr"
    ],
    "data": [
        ...
        'views/quality_report_feed_lines.xml',
        'views/quality_report_trims_lines.xml',
        'views/quality_report_sewing_lines.xml',
    ],
    'installable': True,
    'application': True,
    'auto_install': False,
